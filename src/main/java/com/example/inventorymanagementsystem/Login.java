...
public class Login extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jPanel1.setBackground(new Color(255, 165, 0));
        ...
        this.jLabel3.setText("INVENTORY MANAGER");
        ...
        this.jTable1.setModel(new DefaultTableModel(new Object[][]{{"10862078", "password", "administrator"}}, new String[]{"Username", "Password", "Type"}) {
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this.rootPane, "Please Enter your username", "Error occurred!!", 2);
        } else if (password.isEmpty()) {
            JOptionPane.showMessageDialog(this.rootPane, "Please Enter your password", "Error occurred!!", 2);
        } else if (username.equals("10862078") && password.equals("password")) {
            ...
            JOptionPane.showMessageDialog(this.rootPane, "Admin UserName and Password do not match ", "Error", 2);
        }
